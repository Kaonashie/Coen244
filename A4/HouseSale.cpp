...
// Getter methods
std::string HouseSale::get_house_type() const { return house_type; }
int HouseSale::get_year_built() const { return year_built; }
int HouseSale::get_no_rooms() const { return no_rooms; }
int HouseSale::get_sale_price() const { return sale_price; }
