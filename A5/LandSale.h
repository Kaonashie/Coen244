...
class LandSale : public Property {
   ...
   public:
    // Constructors
    LandSale(std::string address = "", Customer customer = Customer(), int agent_id = 0, Date listing_date = Date(),
	     Date sell_date = Date(), int sold_price = 0, double area_of_land = 0, int sale_price = 0);
